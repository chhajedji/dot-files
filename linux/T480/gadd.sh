...
cp -r  $HOME/.gitconfig $HOME/.bash $HOME/.inputrc $HOME/.Xresources $HOME/.scripts/ $HOME/gadd.sh $HOME/.alias $HOME/.vimrc $HOME/.profile $HOME/.bashrc $HOME/.fonts $HOME/pnl/github/dot-files/linux/T480/
git status
